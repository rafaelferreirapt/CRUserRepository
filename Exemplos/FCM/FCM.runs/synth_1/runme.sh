...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exemplos/FCM/FCM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FCM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source FCM.tcl
