...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Repository/MaxNetworkExam/MaxNetworkExam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MaxNetworkExam.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MaxNetworkExam.tcl
