...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Repository/resetCircuit/resetCircuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log resetCircuit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source resetCircuit.tcl
