...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Repository/circuito_c/circuito_c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source circuit.tcl
