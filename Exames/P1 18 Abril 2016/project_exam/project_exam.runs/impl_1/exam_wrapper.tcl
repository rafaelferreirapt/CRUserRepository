...
set rc [catch {
  ...
  {/media/psf/Home/Development/ect_ua/UserRepository/Exames/P1 18 Abril 2016/project_exam/project_exam.cache/ip}
  /media/psf/Home/Development/ect_ua/UserRepository/Repository
} [current_project]
  set_property ip_output_repo {{/media/psf/Home/Development/ect_ua/UserRepository/Exames/P1 18 Abril 2016/project_exam/project_exam.cache/ip}} [current_project]
  add_files -quiet {{/media/psf/Home/Development/ect_ua/UserRepository/Exames/P1 18 Abril 2016/project_exam/project_exam.runs/synth_1/exam_wrapper.dcp}}
