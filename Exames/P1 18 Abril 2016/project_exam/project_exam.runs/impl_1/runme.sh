...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P1 18 Abril 2016/project_exam/project_exam.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exam_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source exam_wrapper.tcl -notrace
