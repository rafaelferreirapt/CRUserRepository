...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 14 Abril 2015/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exame_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source exame_wrapper.tcl
