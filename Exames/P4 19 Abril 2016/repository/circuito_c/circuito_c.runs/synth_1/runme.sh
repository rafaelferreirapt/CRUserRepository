...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P4 19 Abril 2016/repository/circuito_c/circuito_c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit_c.vds -m64 -mode batch -messageDb vivado.pb -notrace -source circuit_c.tcl
