...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P4 19 Abril 2016/repository/showRam/showRam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log showRam.vds -m64 -mode batch -messageDb vivado.pb -notrace -source showRam.tcl
