...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P4 19 Abril 2016/repository/circuito_m/circuito_m.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuito_m.vds -m64 -mode batch -messageDb vivado.pb -notrace -source circuito_m.tcl
