...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P1 13 Abril 2015/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exam_design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source exam_design_wrapper.tcl -notrace
