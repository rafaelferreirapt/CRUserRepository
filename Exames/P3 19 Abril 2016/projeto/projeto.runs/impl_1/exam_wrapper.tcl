...
set rc [catch {
  ...
  set_property webtalk.parent_dir {/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 19 Abril 2016/projeto/projeto.cache/wt} [current_project]
  set_property parent.project_path {/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 19 Abril 2016/projeto/projeto.xpr} [current_project]
  set_property ip_repo_paths {
  {/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 19 Abril 2016/projeto/projeto.cache/ip}
  {/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 19 Abril 2016/repository}
} [current_project]
  set_property ip_output_repo {{/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 19 Abril 2016/projeto/projeto.cache/ip}} [current_project]
  add_files -quiet {{/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 19 Abril 2016/projeto/projeto.runs/synth_1/exam_wrapper.dcp}}
  read_xdc {{/media/psf/Home/Development/ect_ua/UserRepository/Exames/P3 19 Abril 2016/projeto/projeto.srcs/constrs_1/imports/xdc/Nexys4_Master.xdc}}
