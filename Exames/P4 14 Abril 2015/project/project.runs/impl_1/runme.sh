...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P4 14 Abril 2015/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source project_wrapper.tcl -notrace
