...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Exames/P4 14 Abril 2015/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source project_wrapper.tcl
