...
HD_PWD='K:/CR_MicroBlase/MB2/MB2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_swled_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source MB_swled_wrapper.tcl -notrace
