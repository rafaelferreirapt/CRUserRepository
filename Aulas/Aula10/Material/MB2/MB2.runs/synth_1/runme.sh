...
HD_PWD='K:/CR_MicroBlase/MB2/MB2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_swled_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MB_swled_wrapper.tcl
