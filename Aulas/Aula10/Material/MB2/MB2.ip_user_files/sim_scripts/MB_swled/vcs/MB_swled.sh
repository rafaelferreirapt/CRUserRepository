...
reset_run()
{
  files_to_remove=(ucli.key MB_swled_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc MB_swled_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.MB_swled xil_defaultlib.glbl -o MB_swled_simv
}
...
simulate()
{
  ...
  ./MB_swled_simv $opts -do simulate.do
}
# Script usage
usage()
{
