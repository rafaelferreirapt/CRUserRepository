...
#
# Generated by Vivado on Sun May 01 13:49:38 +0100 2016
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: MB_swled.sh [-help]
# usage: MB_swled.sh [-lib_map_path]
# usage: MB_swled.sh [-noclean_files]
# usage: MB_swled.sh [-reset_run]
#
...
# executing this script. Please type 'MB_swled.sh -help' for more information.
#
...
# Script info
echo -e "MB_swled.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: MB_swled.sh [-help]\n\
Usage: MB_swled.sh [-lib_map_path]\n\
Usage: MB_swled.sh [-reset_run]\n\
Usage: MB_swled.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./MB_swled.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./MB_swled.sh -help\" for more information)\n"
        exit 1
      fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_microblaze_0_0/sim/MB_swled_microblaze_0_0.vhd" \

  ncvhdl -work lmb_v10_v3_0_7 $opts_vhd \
    "$ref_dir/../../../ipstatic/lmb_v10_v3_0/hdl/vhdl/lmb_v10.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_dlmb_v10_0/sim/MB_swled_dlmb_v10_0.vhd" \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_ilmb_v10_0/sim/MB_swled_ilmb_v10_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_dlmb_bram_if_cntlr_0/sim/MB_swled_dlmb_bram_if_cntlr_0.vhd" \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_ilmb_bram_if_cntlr_0/sim/MB_swled_ilmb_bram_if_cntlr_0.vhd" \

  ncvhdl -work blk_mem_gen_v8_3_1 $opts_vhd \
    "$ref_dir/../../../ipstatic/blk_mem_gen_v8_3/simulation/blk_mem_gen_v8_3.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_lmb_bram_0/sim/MB_swled_lmb_bram_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_mdm_1_0/sim/MB_swled_mdm_1_0.vhd" \

  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_clk_wiz_1_0/MB_swled_clk_wiz_1_0_clk_wiz.v" \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_clk_wiz_1_0/MB_swled_clk_wiz_1_0.v" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_rst_clk_wiz_1_100M_0/sim/MB_swled_rst_clk_wiz_1_100M_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_axi_gpio_0_0/sim/MB_swled_axi_gpio_0_0.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_xbar_0/sim/MB_swled_xbar_0.v" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_auto_pc_0/sim/MB_swled_auto_pc_0.v" \
    "$ref_dir/../../../bd/MB_swled/ip/MB_swled_auto_pc_1/sim/MB_swled_auto_pc_1.v" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/MB_swled/hdl/MB_swled.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.MB_swled xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.MB_swled -input simulate.do
}
# Script usage
usage()
{
