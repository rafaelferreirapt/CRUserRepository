...
#
# Generated by export_simulation on Sun May 01 13:49:38 +0100 2016
#
################################################################################
...
switch to the './MB_swled.sh' script.

./MB_swled.sh -reset_run
...
./MB_swled.sh -noclean_files

For more information on the script, please type './MB_swled.sh -help'.
