...
#
# Generated by Vivado on Sun May 01 10:01:01 +0100 2016
...
create_lib_mappings()
{
  libs=(microblaze_v9_5_3 xil_defaultlib lmb_v10_v3_0_7 lmb_bram_if_cntlr_v4_0_7 blk_mem_gen_v8_3_1 axi_lite_ipif_v3_0_3 mdm_v3_2_4 lib_cdc_v1_0_2 proc_sys_reset_v5_0_8)
  file="cds.lib"
  dir="ies"
...
elaborate()
{
  ...
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname microblaze_v9_5_3 -libname xil_defaultlib -libname lmb_v10_v3_0_7 -libname lmb_bram_if_cntlr_v4_0_7 -libname blk_mem_gen_v8_3_1 -libname axi_lite_ipif_v3_0_3 -libname mdm_v3_2_4 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_8"
  ncelab $opts xil_defaultlib.DMB1 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.DMB1 -input simulate.do
}
# Script usage
usage()
{
