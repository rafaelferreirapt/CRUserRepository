...
HD_PWD='/media/psf/Home/Development/ect_ua/UserRepository/Aulas/Aula10/ex1/MB1/MB1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DMB1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source DMB1_wrapper.tcl -notrace
