...
#
# Generated by Vivado on Wed May 11 15:49:26 WEST 2016
...
# Script info
echo -e "DMB1.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./DMB1.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_lmb_bram_0/sim/DMB1_lmb_bram_0.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.DMB1 xil_defaultlib.glbl -o DMB1_simv
}
