...
#
# Generated by Vivado on Fri May 13 00:29:31 BST 2016
# IP Build 1537824 on Fri Apr  8 04:28:57 MDT 2016 
#
# usage: DMB1.sh [-help]
# usage: DMB1.sh [-lib_map_path]
# usage: DMB1.sh [-noclean_files]
# usage: DMB1.sh [-reset_run]
#
...
# executing this script. Please type 'DMB1.sh -help' for more information.
#
...
# Script info
echo -e "DMB1.sh - Script generated by export_simulation (Vivado v2016.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_microblaze_0_0/sim/DMB1_microblaze_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_dlmb_v10_0/sim/DMB1_dlmb_v10_0.vhd" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_ilmb_v10_0/sim/DMB1_ilmb_v10_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_dlmb_bram_if_cntlr_0/sim/DMB1_dlmb_bram_if_cntlr_0.vhd" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_ilmb_bram_if_cntlr_0/sim/DMB1_ilmb_bram_if_cntlr_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_lmb_bram_0/sim/DMB1_lmb_bram_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_mdm_1_0/sim/DMB1_mdm_1_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_clk_wiz_1_0/DMB1_clk_wiz_1_0_clk_wiz.v" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_clk_wiz_1_0/DMB1_clk_wiz_1_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_rst_clk_wiz_1_100M_0/sim/DMB1_rst_clk_wiz_1_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_xbar_0/sim/DMB1_xbar_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_auto_pc_0/sim/DMB1_auto_pc_0.v" \
    "$ref_dir/../../../bd/DMB1/ip/DMB1_auto_pc_1/sim/DMB1_auto_pc_1.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/DMB1/hdl/DMB1.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DMB1 xil_defaultlib.glbl -o DMB1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DMB1_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./DMB1.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(xil_defaultlib xpm microblaze_v9_6_0 lmb_v10_v3_0_8 lmb_bram_if_cntlr_v4_0_8 blk_mem_gen_v8_3_2 axi_lite_ipif_v3_0_3 mdm_v3_2_5 lib_cdc_v1_0_2 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_8 fifo_generator_v13_1_0 axi_data_fifo_v2_1_7 axi_crossbar_v2_1_9 axi_protocol_converter_v2_1_8)
...
reset_run()
{
  files_to_remove=(ucli.key DMB1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc DMB1_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./DMB1.sh -help\" for more information)\n"
    exit 1
  fi
