...
compile()
{
  ...
  vlogan -work axi_protocol_converter_v2_1_7 $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.MP3_Design xil_defaultlib.glbl -o MP3_Design_simv
}
...
simulate()
{
  ...
  ./MP3_Design_simv $opts -do simulate.do
}
# Script usage
usage()
{
